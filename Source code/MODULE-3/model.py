...
root=r'E:\Heart_disease_diagnose_\module-3'
path_df = os.path.join(root, 'preprocess_dataset/combined_dataset.csv')
...
model_path = os.path.join(root, 'sav/rfc.sav')
joblib.dump(clf, model_path)

# Saving the scaler object
scaler_path = os.path.join(root, 'sav/heart_model.pkl')
